...
# Choices: prod, staging, dev (local), test
...
# TODO setup read/write router between primary and replica databases, db defaults and any supporting methods
# Database
...
if DEBUG:
    # Render browsable API only in DEBUG. Disable in production.
